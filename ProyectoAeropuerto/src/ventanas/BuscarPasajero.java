			...
			glPanelIzquierda.createParallelGroup(Alignment.LEADING)
				.addGroup(glPanelIzquierda.createSequentialGroup()
					...
					.addGroup(glPanelIzquierda.createParallelGroup(Alignment.TRAILING)
						.addGroup(Alignment.LEADING, glPanelIzquierda.createSequentialGroup()
							...
							.addGroup(glPanelIzquierda.createParallelGroup(Alignment.LEADING)
								.addGroup(glPanelIzquierda.createSequentialGroup()
									...
									.addGroup(glPanelIzquierda.createParallelGroup(Alignment.TRAILING)
										...
										.addComponent(lblMensajeDNI, GroupLayout.PREFERRED_SIZE, 254, GroupLayout.PREFERRED_SIZE)))
								.addGroup(glPanelIzquierda.createSequentialGroup()
						...
						.addGroup(Alignment.LEADING, glPanelIzquierda.createSequentialGroup()
							...
							.addGap(48)
							.addComponent(txtApellido, GroupLayout.PREFERRED_SIZE, 166, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(lblMensajeApellido, GroupLayout.PREFERRED_SIZE, 254, GroupLayout.PREFERRED_SIZE)))
					.addContainerGap())
		);
